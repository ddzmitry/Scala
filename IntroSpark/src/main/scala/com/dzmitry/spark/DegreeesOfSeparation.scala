...
//      println("SUPER HEROOOO")
  ...
  def main(args: Array[String]): Unit = {
    ...
    val spark = SparkSession.builder
      .appName("Degrees Of Separation")  // optional and will be autogenerated if not specified
      .master("local[*]")               // only for demo and testing purposes, use spark-submit instead
      .config("spark.sql.warehouse.dir", "target/spark-warehouse")
      .getOrCreate()
//    Assign Hit Counter to
    hitCounter = Some(spark.sparkContext.longAccumulator("Hit Counter"))

    var iterationRdd = createStartingRdd(spark.sparkContext)
